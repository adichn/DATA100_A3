...
p1 <- ggplot(combined_data, aes(x = avg_max_wind, y = arctic_min_extent)) +
  geom_point(color = "blue") +
  geom_smooth(method = "lm", color = "red", se = FALSE) +
  labs(title = "Correlation between Cyclone Activity (Avg Max Wind) and Arctic Ice Extent",
       x = "Average Max Wind Speed (Cyclones)",
       y = "Arctic Minimum Ice Extent (million sq km)") +
  theme_minimal()

p2 <- ggplot(combined_data, aes(x = avg_max_wind, y = antarctic_min_extent)) +
  geom_point(color = "blue") +
  geom_smooth(method = "lm", color = "red", se = FALSE) +
  labs(title = "Correlation between Cyclone Activity (Avg Max Wind) and Antarctic Ice Extent",
       x = "Average Max Wind Speed (Cyclones)",
