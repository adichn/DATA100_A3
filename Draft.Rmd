...
The preliminary step in supporting the analysis involved converting the coordinates into the Cartesian coordinate system. Next, we used the `rnaturalearth` package and `geolocation` to convert the coordinates into country identifiers and determine each storm's distance from the equator. As shown in Figure 1 in the appendix, cyclones are now distributed across the North Atlantic and Northeast Pacific basins.
...
): a significant concentration of COVID-19 cases appears within the 1500-2500 km range from the equator, suggesting a strong relationship between COVID-19 cases and cyclone activity within a margin of approximately 9 degrees of longitude.
